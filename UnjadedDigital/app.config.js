...
const APP_NAME = process.env.APP_NAME || 'UnjadedDigital';
const APP_SLUG = process.env.APP_SLUG || 'unjadeddigital';
const SCHEME = process.env.APP_SCHEME || 'unjadeddigital';
const BUNDLE_ID = process.env.APP_BUNDLE_ID || 'com.unjadeddigital.template';
