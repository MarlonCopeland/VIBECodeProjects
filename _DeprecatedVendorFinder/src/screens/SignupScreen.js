...
export default function SignupScreen({ navigation }) {
  ...
  const onSubmit = async () => {
    ...
    // Supabase auth is email-based; require a valid email there.
    if (backendMode === 'supabase' && !email) {
      Alert.alert('Email required', 'An email address is required to create your account.');
      return;
    }
    setBusy(true);
    try {
